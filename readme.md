...
### App
Sets up a new AngularJS app, generating all the boilerplate you need to get started. The app generator also optionally installs Twitter Foundation and additional AngularJS modules, such as angular-resource.
